	...
	return (
		<div className="whiteboard-toolbar">
			<div className="whiteboard-toolbar__section">
				<h4 className="whiteboard-toolbar__title">Инструменты</h4>
			...
			<div className="whiteboard-toolbar__section">
				<h4 className="whiteboard-toolbar__title">Фигуры</h4>
				<div className="whiteboard-toolbar__tools">
					<button
			...
			<div className="whiteboard-toolbar__section">
				<h4 className="whiteboard-toolbar__title">Действия</h4>
				<div className="whiteboard-toolbar__tools">
					<button
