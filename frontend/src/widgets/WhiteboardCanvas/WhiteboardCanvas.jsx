...
import { useWhiteboard } from '@shared/hooks/useWhiteboard'
import WhiteboardToolbar from '@widgets/WhiteboardToolbar'
import ToolSettings from '@widgets/ToolSettings'
	...
	return (
		<div className="whiteboard">
			...
			<ConfirmModal
				...
				message="Вы уверены, что хотите полностью очистить доску? Это действие необратимо."
